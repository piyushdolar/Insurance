<template>
  <div>
    <md-dialog
      :md-active.sync="ResetPasswordDialogBox"
    ...
    >
      ...
      <md-dialog-content>
        <div class="md-layout">
          ...
          >
            <md-field :class="getValidationClass('password')">
              ...
              <span class="md-error" v-if="!$v.form.password.required"
                >The password is required to update.</span
              >
          ...
          <div class="md-layout-item md-size-100">
            <md-switch v-model="form.checkMe"
              >Check here to confirm that you are changing password.</md-switch
            >
          </div>
        </div>
      </md-dialog-content>
...
export default {
  ...
  methods: {
    ...
    updatePassword(value) {
      this.resetData();
      this.$emit("onResetPasswordDialogData", value);
    },
    resetData() {
