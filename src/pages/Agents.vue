	...
	<div class="content">
		<div class="md-layout">
			...
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
				...
				<md-button class="md-primary pull-right" @click="openDialog"> <md-icon>add</md-icon>ADD AGENT </md-button>
			</div>
            ...
            :data="tableData"-->
						...
						>
							<template slot="picture" scope="props">
								<img v-if="props.rowData.picture != null" :src="require('../assets/img/avatars/agents/' + props.rowData.picture)" alt="profile-image" />
		...
		onAction(action, data, index) {
			if (action == 'edit') {
				...
				if (data.picture != null) {
					this.form.imagePreview = require('../assets/img/avatars/agents/' + data.picture);
				}
