	...
	<div class="content">
		<div class="md-layout">
			...
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
				<!-- CREATE AGENT MODAL -->
				<md-dialog :md-active.sync="showDialog" class="modal-large" :md-click-outside-to-close="false">
							...
							<div class="md-layout md-gutter">
								<div class="md-layout-item md-small-size-100">
									<md-field :class="getValidationClass('provinceId')">
										...
										>
											<md-option v-for="province in getLocationProvince" :key="province.id" :value="province.id">{{ province.nameEng }}</md-option>
										</md-select>
								...
								<div class="md-layout-item md-small-size-100">
									<md-field :class="getValidationClass('districtId')">
										...
										<md-select name="locationDistrict" id="locationDistrict" v-model="form.districtId" md-dense :disabled="sending">
											<md-option v-for="district in getLocationDistrict" :key="district.id" :value="district.id">{{ district.nameEng }}</md-option>
										</md-select>
								...
								<div class="md-layout-item md-small-size-100">
									<md-field :class="getValidationClass('villageName')">
										...
										<md-input name="village-name" id="village-name" autocomplete="village-name" v-model="form.villageName" :disabled="sending" />
										<span class="md-error" v-if="!$v.form.villageName.required">The village name is required</span>
									</md-field>
								</div>
							</div>
							...
							<div class="md-layout md-gutter">
								<div class="md-layout-item md-small-size-100">
									<md-field>
										...
										<md-input name="fax-number" id="fax-number" autocomplete="fax-number" v-model="form.faxNumber" :disabled="sending" />
									</md-field>
								</div>
								<div class="md-layout-item md-small-size-100">
									<md-field :class="getValidationClass('bankName')">
										<label for="bank-name">Bank Name</label>
										<md-input name="bank-name" id="bank-name" autocomplete="bank-name" v-model="form.bankName" :disabled="sending" />
										<span class="md-error" v-if="!$v.form.bankName.required">The bank account name is required</span>
									</md-field>
								</div>
								<div class="md-layout-item md-small-size-100">
									<md-field :class="getValidationClass('bankAcNumber')">
										...
										<md-input
											...
											:disabled="sending"
										/>
										<span class="md-error" v-if="!$v.form.bankAcNumber.required">The bank account number is required</span>
									</md-field>
								</div>
							</div>
								...
								<div class="md-layout-item md-small-size-100">
									<md-field :class="getValidationClass('familyBookNumber')">
										...
										<md-input
											...
											:disabled="sending"
										/>
										<span class="md-error" v-if="!$v.form.familyBookNumber.required">The family book number is required</span>
									</md-field>
								</div>
								<div class="md-layout-item md-small-size-100">
									<md-datepicker
									...
									>
										...
										<span class="md-error" v-if="!$v.form.familyBookDOI.required">The family book date of issue is required</span>
									</md-datepicker>
								</div>
							</div>
								...
								<div class="md-layout-item md-small-size-100">
									<md-field :class="getValidationClass('personalIdNumber')">
										...
										<md-input
											...
											:disabled="sending"
										/>
										<span class="md-error" v-if="!$v.form.personalIdNumber.required">The Personal ID number is required</span>
									</md-field>
								</div>
								<div class="md-layout-item md-small-size-100">
									<md-datepicker
									...
									>
										...
										<span class="md-error" v-if="!$v.form.personalIdDOI.required">The family book date of issue is required</span>
									</md-datepicker>
								</div>
							</div>
							...
							<div class="md-layout md-gutter" v-if="!formModal.isEdit">
								<div class="md-layout-item md-small-size-100">
									<md-field :class="getValidationClass('password')">
										...
										<span class="md-error" v-if="!$v.form.password.required">The password field is required.</span>
				...
				<div class="pull-right md-layout">
					<md-button class="md-primary md-layout-item" @click="downloadCSV({ url: 'users', userType: 2 })">
					...
					<md-button class="md-info md-layout-item" @click="openDialog" v-if="checkAuthorization('write')">
						...
						<md-tooltip md-direction="top">Create Agent for your system</md-tooltip>
					</md-button>
				</div>
			</div>
			...
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100 vuetable">
				<md-card class>
					<md-card-header data-background-color="purple">
						...
						<p class="category">
							Here you can find and see every agent's details
						</p>
					</md-card-header>
					<md-card-content>
						<div class="md-layout md-gutter">
						...
						<div class="md-layout">
							<div class="md-layout-item table-responsive">
								...
								>
									...
									<template slot="location" slot-scope="props" v-if="props.rowData.locationId != null"
									...
									<template slot="actions" slot-scope="props">
										<div class="custom-actions">
											...
											<md-button class="md-primary md-just-icon" @click="onAction('reset-password', props.rowData, props.rowIndex)">
												<md-icon>lock</md-icon>
												<md-tooltip md-direction="top">Reset Password</md-tooltip>
											</md-button>
											<md-button class="md-danger md-just-icon" @click="onAction('delete', props.rowData, props.rowIndex)">
