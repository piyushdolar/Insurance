            ...
            :data="tableData"-->
						...
						>
							<template slot="picture" scope="props">
								<img v-if="props.rowData.picture != null" :src="require('@/assets/img/avatars/' + props.rowData.picture)" alt="profile-image" />
		...
		onAction(action, data, index) {
			if (action == 'edit') {
				...
				if (data.picture != null) {
					this.form.imagePreview = require('@/assets/img/avatars/' + data.picture);
				}
