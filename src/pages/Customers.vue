		...
		<div class="md-layout">
			...
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
				...
				<div class="pull-right md-layout">
					<md-button class="md-info md-round mr-10" @click="downloadCSV({ url: 'customers' })" v-show="checkAuthorization('write')">
						<md-icon>cloud_download</md-icon>Generate Excel
						<md-tooltip md-direction="top">Generate Excel & Download it.</md-tooltip>
					</md-button>
					<md-button class="md-info md-round" @click="openDialog" v-show="checkAuthorization('write')">
