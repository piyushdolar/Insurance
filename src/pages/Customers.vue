	...
	<div class="content">
		<div class="md-layout">
			...
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
				...
				<md-button class="md-primary pull-right" @click="showDialog = true"><md-icon>add</md-icon> Add Customer</md-button>
			</div>
				...
				<md-card>
					...
					<md-card-content>
						<md-table v-model="searched" md-sort="name" md-sort-order="asc" md-card md-fixed-header>
							...
							<md-table-empty-state md-label="No agents found" :md-description="`No agent found for this '${search}' query. Try a different search term or create a new agent.`">
