<template>
	<div class="content">
		<div class="md-layout">
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
				...
				>
					...
					<template slot="footer">
						<div class="stats"><md-icon>access_time</md-icon>Last updated recently</div>
					</template>
				</chart-card>
			</div>
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-50">
				<chart-card :chart-data="dailySalesChart.data" :chart-options="dailySalesChart.options" :chart-type="'Line'" data-background-color="blue">
					<template slot="content">
						...
						<p class="category">
							<span class="text-success"> <i class="fas fa-long-arrow-alt-up"></i> 50% </span>
			...
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-50">
				<chart-card :chart-data="dataCompletedTasksChart.data" :chart-options="dataCompletedTasksChart.options" :chart-type="'Line'" data-background-color="green">
					<template slot="content">
			...
			<div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-25">
				<stats-card data-background-color="green">
					...
					<template slot="footer">
						<div class="stats"><md-icon>date_range</md-icon>Last updated recently</div>
					</template>
				</stats-card>
			</div>
			<div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-25">
			...
			<div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-25">
				<stats-card data-background-color="red">
					...
					<template slot="footer">
						<div class="stats"><md-icon>local_offer</md-icon>Tracked from live server</div>
					</template>
				</stats-card>
			</div>
			<div class="md-layout-item md-medium-size-50 md-xsmall-size-100 md-size-25">
...
<script>
import { StatsCard, ChartCard, NavTabsCard, NavTabsTableAgent, NavTabsTableHolders, NavTabsTablePolicy, OrderedTable } from '@/components';
...
export default {
	...
	data() {
		return {
			...
			// CHART GREEN (No. Agents);
			dataCompletedTasksChart: {
				data: {
					labels: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'],
					series: [[30, 50, 50, 30, 20, 40, 90]]
				},
	...
	created() {
		...
		// console.log(this.getDashboardCharts.policy_holders);
		/* // Policy holders
		this.emailsSubscriptionChart.data.labels = this.getDashboardCharts.policy_holders.label;
		this.emailsSubscriptionChart.data.series = [this.getDashboardCharts.policy_holders.data];

		// Daily sales
		this.dailySalesChart.data.labels = this.getDashboardCharts.daily_sales.label;
		this.dailySalesChart.data.series = [this.getDashboardCharts.daily_sales.data]; */
	},
	computed: {
