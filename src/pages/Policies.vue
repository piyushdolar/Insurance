	...
	<div class="content">
		<div class="md-layout">
			...
			<div class="md-layout-item md-medium-size-100 md-xsmall-size-100 md-size-100">
				...
				<md-dialog :md-active.sync="showHistoryModal" class="modal-large" :md-click-outside-to-close="false" :md-close-on-esc="false">
							...
							<div class="md-layout-item table-responsive">
								...
								>
									...
									<template slot="contract" slot-scope="props">
										<md-chip data-background-color="orange" v-if="props.rowData.renew != null">Renewed</md-chip>
										<md-chip data-background-color="green" v-else>New</md-chip>
									</template>
									<template slot="policyType" slot-scope="props">
										<md-chip data-background-color="purple" v-if="props.rowData.policyType == 1">Motor</md-chip>
									...
									<template slot="status" slot-scope="props">
										...
										<md-chip data-background-color="blue" v-if="props.rowData.status == 2">In-Correction</md-chip>
