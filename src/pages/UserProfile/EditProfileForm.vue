	...
	<form novalidate @submit.prevent="validateUser" enctype="multipart/form-data">
		<md-card class="md-card-profile">
			<div class="md-card-avatar">
				<img class="img" v-if="form.picture != null" :src="`/images/avatars/users/${form.picture}`" alt="image-preview" />
				...
				<div class="md-layout">
					...
					<div class="md-layout-item md-small-size-100 md-size-50">
						<md-field :class="getValidationClass('password')">
							...
							<span class="md-error" v-if="!$v.form.password.minLength">The password minimum length is 6 character long.</span>
						</md-field>
					</div>
					<div class="md-layout-item md-small-size-100 md-size-50">
						<md-field :class="getValidationClass('passwordRepeat')">
							...
							<span class="md-error" v-if="!$v.form.passwordRepeat.sameAs">The password dosen't match.</span>
						</md-field>
					</div>
					...
					<div class="md-layout-item md-small-size-100 md-size-100">
						<md-field :class="getValidationClass('address')">
							...
							<md-textarea name="address" id="address" autocomplete="address" v-model="form.address" />
